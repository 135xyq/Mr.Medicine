...
}, tt.decode = et, tt.isValid = We, tt.verify = Ze;
var rt = tt,
	nt = {
...
var yt = function(e, t) {
	...
	wt = te((function(e, t) {
		...
		}, t.gt = z, t.lt = J, t.eq = W, t.neq = Z, t.gte = ee, t.lte = te, t.cmp = re, t.Comparator = ne;
		var ie = {};
		...
		e = $t(e) ? e : (i = e) ? Ot(i, function(e) {
			...
			var t = function(e) {
					...
					if ((e = function(e) {
							...
							e = e.replace(Et, "");
							var r = At.test(e);
							return r || St.test(e) ? xt(e.slice(2), r ? 2 : 8) : Ct.test(e) ? NaN : +e
						}(e)) === 1 / 0 || e === -1 / 0) {
		...
		return "number" == typeof e && e == function(e) {
			var t = function(e) {
					...
					if ((e = function(e) {
							...
							e = e.replace(Yt, "");
							var r = Jt.test(e);
							return r || Wt.test(e) ? Zt(e.slice(2), r ? 2 : 8) : zt.test(e) ? NaN : +e
						}(e)) === 1 / 0 || e === -1 / 0) {
						return 17976931348623157e292 * (e < 0 ? -1 : 1)
					}
					return e == e ? e : 0
...
var cn = Object.freeze({
	...
	loginByQQ: async function({
		...
		let m = await P.where(l.or(...f)).get();
		if (m = this._getCurrentAppUser(m.data), m && m.length > 0) {
			if ("register" === o) return {
				code: 10802,
				messageValues: {
	...
	bindRole: async function({
		...
		const n = {};
		return "string" == typeof t && (t = [t]), n.role = r ? t : zr.push(t), await P.doc(e).update(n), {
			code: 0,
			msg: ""
		}
	},
	bindPermission: async function({
		...
		const n = {};
		return "string" == typeof t && (t = [t]), n.permission = r ? t : zr.push(t), await j.where({
			role_id: e
		}).update(n), {
			code: 0,
			msg: ""
	...
	getSupportedLoginType: function({
		...
		for (const e in on) on[e](r) && n.push(e);
		return {
...
class dn {
		...
		this.pluginConfig = n, this.config = r || this._getConfigContent(), this._configCache = {}, Object
			.defineProperty(this, "context", {
				get() {
					...
					if (a && ("app" === s || "app-plus" === s)) {
						if (a.preferedAppPlatform) {
							if ("app" !== a.preferedAppPlatform && "app-plus" !== a.preferedAppPlatform)
								throw new Error("invalid preferedAppPlatform value in config");
							r.PLATFORM = a.preferedAppPlatform
						}
						if ("app" === r.PLATFORM && a["app-plus"] || "app-plus" === r.PLATFORM && a.app)
							throw new Error(
	...
	_getConfig({
		...
		"app" !== t && "app-plus" !== t || (t = n.preferedAppPlatform || t);
		...
		get(e, t) {
			if (t in e && 0 !== t.indexOf("_")) {
				if ("function" == typeof e[t]) return (r = e[t], function() {
					...
					return f(e) ? e.then(e => (x.bind(this)(e), e)) : (x.bind(this)(e), e)
				}).bind(e);
